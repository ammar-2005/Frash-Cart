  ...
  <div className="text-xl font-extrabold text-emerald-600">
    {data.price.toFixed(2)} EGP
     ...
     <div className="flex gap-4 mb-6 mt-9">
      ...
      <AddBtn
      prodId={data._id}
  cls="flex flex-1 items-center justify-center gap-2 rounded-full bg-emerald-600 px-6 py-3 text-white shadow-md transition hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2"
  child={
    <>
